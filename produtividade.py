...
AGILIS_POS = [
    ...
    {"p2": "Vanessa De Brito Rodrigues",         "p1": "Vanessa",                    "row_nome": 52, "min_col_letter": "C"},  # Vanessa desde C
]
...
def fill_fsf_flags(ws, header_map):
    ...
    row_ranges = [
        ...
        (22, 25), (27, 30), (32, 35), (37, 40), (42, 45), (47, 50), (52,52)
    ]
...
def main():
    ...
    ROW_RANGES_ATIV = [
        (2, 5), (7, 10), (12, 15), (17, 20),
        (22, 25), (27, 30), (32, 35), (37, 40),  # maria.eduarocha
        (42, 45),                                # matheus.lemos.silva
        (47, 50), 
        (52,52),                      # Vanessa (só Agilis)
    ]
